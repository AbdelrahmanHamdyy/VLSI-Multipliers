...
set fp_units            micro
set fp_top_partition    "simpleMultiplier"         ; # INPUT REQUIRED: Top partition name
...
# PG ring settings
set pg_ring_layers              {metal5 metal4}          ; # Metal layers for the rings in order {Hlayer Vlayer}
