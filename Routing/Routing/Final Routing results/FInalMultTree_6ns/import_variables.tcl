...
set workdir  "/home/vlsi/shared/VLSI-Multipliers/src/Nitro" ;        # REQUIRED: Path to project home
...
##########################################################################################################################
set MGC_importVerilogNetlist "${workdir}/verilog/demo_multiplierTree.syn.v"                     ; # REQUIRED: Path to vg netlist.  Multiple files/wildcards allowed, but must 
                                                      #           match vg files only. NOT REQUIRED FOR mxdb flow.
set MGC_topDesign            "multiplierTree"                ; # REQUIRED  : Name of top level module in verilog netlist(s).
