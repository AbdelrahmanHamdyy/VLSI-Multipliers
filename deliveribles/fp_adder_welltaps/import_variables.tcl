...
set workdir  "/home/vlsi/Desktop/Routing/Nitro" ;        # REQUIRED: Path to project home
...
##########################################################################################################################
set MGC_importVerilogNetlist "${workdir}/verilog/demo_fp_adder_buff.syn.v"                     ; # REQUIRED: Path to vg netlist.  Multiple files/wildcards allowed, but must 
                                                      #           match vg files only. NOT REQUIRED FOR mxdb flow.
set MGC_topDesign            "fp_adder_buff"                ; # REQUIRED  : Name of top level module in verilog netlist(s).
