...
set fp_units            micro
set fp_top_partition    "fp_adder_buff"         ; # INPUT REQUIRED: Top partition name
...
set fp_well_tap_cell              "WELLTAP"                 ; # Specify the lib_cell used for well taps, e.g. WELL_TAP_LIB_CELL
